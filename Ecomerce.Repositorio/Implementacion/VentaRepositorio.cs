...
namespace Ecomerce.Repositorio.Implementacion
{
...

    {
        ...
        private readonly EcomerceMascotasContext _dbContext;

        public VentaRepositorio(EcomerceMascotasContext dbContext) : base(dbContext) 
        {
